...
const AdventurePage = lazy(() => import("../pages/AdventurePage").then((module) => ({ default: module.AdventurePage })));
...
function PageLoader() {
  return (
    <div className="grid min-h-[45dvh] place-items-center text-sm font-semibold text-primary" role="status">
