...
export function AdventureAnimationOverlay() {
  ...
  return (
    ...
    >
      ...
      <div
        className="adventure-animation__glow adventure-animation__glow--one"
        aria-hidden="true"
      />
      <div
        className="adventure-animation__glow adventure-animation__glow--two"
        aria-hidden="true"
      />
      ...
      <div className="adventure-animation__content">
        ...
        <div className="adventure-animation__stage" aria-hidden="true">
          ...
          <div className="adventure-animation__delfi-frame">
            <img
              className="adventure-animation__delfi"
              src={avatar}
              alt=""
            />
          </div>
          <svg
            className="adventure-animation__arrow"
            viewBox="0 0 320 160"
            fill="none"
          >
            <path
          ...
          {isArrival && placeImage ? (
            <img
              className="adventure-animation__target adventure-animation__target--place"
              src={placeImage}
              alt=""
            />
          ) : (
            <div className="adventure-animation__target adventure-animation__target--question">
              ?
            </div>
          )}
        </div>
        ...
        <button
          type="button"
          className="adventure-animation__button"
          onClick={close}
        >
          {isArrival
            ? "Ver la pista"
            : nextMission
              ? "Descubrir siguiente pista"
              : "Continuar"}
        </button>
      </div>
    </div>
