  ...
  return (
    <header className="flex items-center justify-between gap-4 px-5 pb-3 pt-[calc(1rem_+_env(safe-area-inset-top))]">
      <Link to="/" className="group inline-flex min-w-0 items-center gap-3" aria-label="Ir al inicio">
        <span className="grid size-10 shrink-0 place-items-center rounded-2xl border border-white/70 bg-[linear-gradient(135deg,#0b416c,#55bde4)] text-white shadow-[0_10px_28px_rgba(23,110,166,0.26)] transition group-hover:-rotate-3">
