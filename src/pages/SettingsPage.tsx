      ...
      <PageContainer className="space-y-4 pt-5">
        <section className="rounded-[1.7rem] border border-white/75 bg-white/70 p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-muted">
            V0.1 no tiene cuentas ni backend y no guarda tu ubicación. Solo conserva localmente el progreso de la pista de demostración.
          </p>
        </section>
        <section className="rounded-[1.7rem] border border-white/75 bg-white/70 p-6">
          <h2 className="font-display text-2xl text-ink">Demo</h2>
          <p className="mt-2 text-sm leading-6 text-muted">Borrá el progreso local para volver a vivir la primera pista.</p>
